...
while traci.simulation.getMinExpectedNumber() > 0:
    ...
    # VSL section
    g1Enter = sum([
        traci.lanearea.getLastStepVehicleNumber("g1Enter_1"),
        traci.lanearea.getLastStepVehicleNumber("g1Enter_2")
    ])

    g2Enter = sum([
        traci.lanearea.getLastStepVehicleNumber("g2Enter_1"),
        traci.lanearea.getLastStepVehicleNumber("g2Enter_2")
    ])

    g3Enter = sum([
        traci.lanearea.getLastStepVehicleNumber("g3Enter_1"),
        traci.lanearea.getLastStepVehicleNumber("g3Enter_2")
    ])
    ...
    g1SpeedLimit = get_speed(g1Enter)
    g2SpeedLimit = get_speed(g2Enter)
    g3SpeedLimit = get_speed(g3Enter)
    
    traci.edge.setMaxSpeed("-E0", g1SpeedLimit)
    traci.edge.setMaxSpeed("-E0.78", g1SpeedLimit)
    traci.edge.setMaxSpeed("97366383.80", g1SpeedLimit)

    traci.edge.setMaxSpeed("97366431#5", g2SpeedLimit)
    traci.edge.setMaxSpeed("97366431#6", g2SpeedLimit)

    traci.edge.setMaxSpeed("97366432#2", g3SpeedLimit)
    traci.edge.setMaxSpeed("97366432#3", g3SpeedLimit)
    # VSL section
    # *************************************************************************
